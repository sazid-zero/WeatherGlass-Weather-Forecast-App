...
export function ThemeProvider(_a) {
    var children = _a.children, _b = _a.defaultTheme, defaultTheme = _b === void 0 ? "system" : _b, _c = _a.storageKey, storageKey = _c === void 0 ? "weather-ui-theme" : _c, props = __rest(_a, ["children", "defaultTheme", "storageKey"]);
    var _d = useState(function () { return localStorage.getItem(storageKey) || defaultTheme; }), theme = _d[0], setTheme = _d[1];
    useEffect(function () {
        var root = window.document.documentElement;
        root.classList.remove("light", "dark", "ocean", "sunset", "forest", "aurora");
        if (theme === "system") {
