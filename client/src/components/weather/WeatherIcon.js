...
export function WeatherIcon({ weatherMain, weatherIcon, size = 'md', animated = true, className = '' }) {
    ...
    return (_jsx(motion.div, { className: `${iconSizes[size]} ${getColor()} ${className}`, ...animations, children: _jsx(IconComponent, { className: "w-full h-full" }) }));
}
// Specialized weather icons for specific use cases
export function SunriseIcon({ className = '' }) {
    return (_jsx(motion.div, { className: `text-orange-400 ${className}`, animate: { y: [0, -2, 0] }, transition: { duration: 3, repeat: Infinity, ease: "easeInOut" }, children: _jsx(Sunrise, { className: "w-full h-full" }) }));
}
export function SunsetIcon({ className = '' }) {
    return (_jsx(motion.div, { className: `text-orange-500 ${className}`, animate: { y: [0, 2, 0] }, transition: { duration: 3, repeat: Infinity, ease: "easeInOut" }, children: _jsx(Sunset, { className: "w-full h-full" }) }));
}
export function WindIcon({ className = '', windSpeed = 0 }) {
    ...
    return (_jsx(motion.div, { className: `text-blue-400 ${className}`, animate: animations[intensity], children: _jsx(Wind, { className: "w-full h-full" }) }));
}
export function VisibilityIcon({ className = '' }) {
    return (_jsx(motion.div, { className: `text-cyan-400 ${className}`, animate: { opacity: [0.7, 1, 0.7] }, transition: { duration: 2, repeat: Infinity, ease: "easeInOut" }, children: _jsx(Eye, { className: "w-full h-full" }) }));
}
